...
switch(THIS_PAGE){
    ...
    case 'gallery.php': 
        ...
        $mainHeadline = 'Welcome to the Candidates Gallery';
        // $center = 'center';
        $body = 'gallery inner';
    break; 
}
...
$people['Donald_Trump'] = 'trump President from NY'; //'trump' is the name of the image for this candidate
$people['Joe_Biden'] = 'biden Vice President from PA';
$people['Hilary_Clinton'] = 'clint Secretary from NY';
...
$people['Andrew_Yang'] = 'ayang Entreprenuer from NY';
...
function randImages2($candidates){
    ...
    echo '<img src="./images/'.$candidates[$i].'.jpg" alt="Randomly generated image">';
} //end randImages2
